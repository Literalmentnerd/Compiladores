...
void til::frame_size_calculator::do_while_node(til::while_node * const node, int lvl) {
...
void til::frame_size_calculator::do_call_node(til::call_node * const node, int lvl) {
  // EMPTY
}
void til::frame_size_calculator::do_null_node(til::null_node * const node, int lvl) {
  // EMPTY
}
...
void til::frame_size_calculator::do_size_of_node(til::size_of_node * const node, int lvl) {
  // EMPTY
}
